    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                #region
                // Test if field are already taken
                do
                {
                    Console.WriteLine();
                    ...
                    try
                    {
                        input = Convert.ToInt32(playerText);
                    }
                    catch
                    {
                        if(playerText == "Exit" || playerText == "exit")
                            Environment.Exit(0);
                        else
                            Console.WriteLine("Please, please enter a number.");
                    }
